...
export function LandingPage() {
  ...
  return (
    <div className="w-full">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-[#009688]/5 to-white py-16 px-4">
      ...
      {/* Trust Section */}
      <section className="py-20 bg-gradient-to-r from-[#0D47A1]/5 to-[#009688]/5">
        <div className="max-w-7xl mx-auto">
      ...
      {/* Stats Section */}
      <div className="mt-6 bg-gradient-to-r from-teal-600 to-blue-700 text-white rounded-2xl shadow-lg p-10 text-center">
        ...
        <p className="text-sm md:text-base mb-8">
          {translations["सुलभ स्वास्थ्य सेवा के लिए सरकार समर्थित पहल"] ||
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm md:text-base">
              {translations["Users Served | उपयोगकर्ताओं की सेवा"] ||
          ...
          <div>
            ...
            <p className="text-sm md:text-base">
              {translations["Languages | भाषाएं"] || "Languages | भाषाएं"}
            </p>
          </div>
          <div>
            <h3 className="text-3xl md:text-4xl font-bold">24/7</h3>
            <p className="text-sm md:text-base">
              {translations["Available | उपलब्ध"] || "Available | उपलब्ध"}
            </p>
          </div>
        </div>
      </div>
